# Generated by Powerlevel10k configuration wizard on 2020-11-25 at 08:01 PST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 24826.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, round separators, sharp heads, round tails, 2 lines, solid, full frame,
...
() {
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND=005
